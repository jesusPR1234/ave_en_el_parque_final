...
SF_intro = SF.Game.extend({
  ...
  render: function () {
    ...
    SF.Draw.text("Jesús Martinez", !1, 100, 34, "green");
    SF.Draw.text("presenta...", !1, 150, 24, "green");
...
SF_splash = SF.Game.extend({
  ...
  render: function () {
    ...
    SF.Bg.hills("#001000");
    SF.Draw.text("Ave en el Parque", !1, 100, 44, "#fff", "#000");
    SF.Draw.text("100 Kilometros de libertad!", !1, 130, 20, "#fff", "rgba(0,0,0,0.5)");
    SF.Draw.text(
      SF.action + " Para empezar",
      !1,
      180,
      14,
    ...
    SF.Draw.text("Puntuación Máxima:  " + SF.hiScore, !1, 30, 14, "rgba(255,255,255,1)");
...
SF_tutorial = SF.Game.extend({
  ...
  render: function () {
    ...
    SF.Draw.text("¿Cómo Jugar?", !1, 40, 22, "#f0f");
    SF.Draw.text("Saltar introducción >", 410, SF.H - 20, 12, "rgba(255,255,255,1)");
    this._super();
  },
  step_1: function () {
    SF.Draw.text(
      "1. " + SF.action + " la pantalla para volar",
      !1,
      70,
      18,
      "#000",
  ...
  step_2: function () {
    SF.Draw.text(
      "2. Come para mantener tus fuerzas",
      !1,
      100,
      18,
      "#000",
  ...
  step_4: function () {
    SF.Draw.text(
      "4. ¡Vuela 100 kilometros hacia la libertad!",
      !1,
      160,
      18,
      "#000",
...
SF_play = SF.Game.extend({
  ...
  render: function () {
    ...
    SF.debug &&
      ...
      SF.Draw.text("Entidades " + SF.entities.length, 350, 30, 12, "#fff"));
    !0 === SF.pause &&
      SF.Draw.text(
        "PAUSA",
        !1,
...
SF_gameOver = SF.Game.extend({
  init: function (a) {
    ...
    this.button = {
      ...
      h: 50,
      col: "#00aced",
      text: { str: "Puntuación del ave", x: !1, y: 260, size: 18, col: "#000" },
  ...
  render: function () {
    ...
    SF.newHiScore &&
      ...
      SF.Draw.text("Nuevo Record!", !1, 150, 20, "#fff"));
...
SF_victory = SF.Game.extend({
  ...
  render: function () {
    SF.Draw.rect(0, 0, SF.W, SF.H, "#333");
    SF.Draw.text("Victoria", !1, 100, 44, "rgba(255,0,255," + SF.fadeText + ")");
    SF.Draw.text("Has ganado!", !1, 150, 30, "#f0f");
    this._super();
    try {
